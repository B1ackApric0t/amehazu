...
$('#g_op').click(function(){
  ...
  $('#vcg').attr('src','data/video/amehazuOPen.webm');
});
$('#g_ed1').click(function(){
  audio.pause()
  $('#cgvideo').css('visibility','visible');
  $('#vcg').attr('src','data/video/amehazuED_Aen.webm');
});
$('#g_ed2').click(function(){
  audio.pause()
  $('#cgvideo').css('visibility','visible');
  $('#vcg').attr('src','data/video/amehazuED_B2en.webm');
});
...
$('#chapter1').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/title.ks",target:"gamestart"})});
$('#chapter2').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/scene2.ks",target:"chapter"})});
$('#chapter3').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/scene3.ks",target:"chapter"})});
$('#chapter4').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/scene4.ks",target:"chapter"})});
$('#chapter5').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/scene5.ks",target:"chapter"})});
$('#chapter6').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/scene6.ks",target:"chapter"})});
$('#chapter7').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/scene7.ks",target:"chapter"})});
$('#chapter8A').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/scene8A.ks",target:"chapter"})});
$('#chapter9A').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/scene9A.ks",target:"chapter"})});
$('#chapter10A').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/scene10A.ks",target:"chapter"})});
$('#chapter8B').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/scene8B.ks",target:"chapter"})});
$('#chapter9B').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/scene9B.ks",target:"chapter"})});
$('#chapter10B').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/scene10B.ks",target:"chapter"})});
$('#chapterEX').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_en/sceneex.ks",target:"chapter"})});
