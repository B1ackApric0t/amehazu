...
$('#g_op').click(function(){
  ...
  $('#vcg').attr('src','data/video/amehazuOPch.mp4');
});
$('#g_ed1').click(function(){
  audio.pause()
  $('#cgvideo').css('visibility','visible');
  $('#vcg').attr('src','data/video/amehazuED_A_zh.mp4');
});
$('#g_ed2').click(function(){
  audio.pause()
  $('#cgvideo').css('visibility','visible');
  $('#vcg').attr('src','data/video/amehazuED_B_zh.mp4');
});
...
$('#chapter1').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/title.ks",target:"gamestart"})});
$('#chapter2').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/scene2.ks",target:"chapter"})});
$('#chapter3').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/scene3.ks",target:"chapter"})});
$('#chapter4').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/scene4.ks",target:"chapter"})});
$('#chapter5').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/scene5.ks",target:"chapter"})});
$('#chapter6').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/scene6.ks",target:"chapter"})});
$('#chapter7').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/scene7.ks",target:"chapter"})});
$('#chapter8A').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/scene8A.ks",target:"chapter"})});
$('#chapter9A').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/scene9A.ks",target:"chapter"})});
$('#chapter10A').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/scene10A.ks",target:"chapter"})});
$('#chapter8B').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/scene8B.ks",target:"chapter"})});
$('#chapter9B').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/scene9B.ks",target:"chapter"})});
$('#chapter10B').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/scene10B.ks",target:"chapter"})});
$('#chapterEX').click(function(){tyrano.plugin.kag.ftag.startTag("jump",{storage:"scenario_ch/sceneex.ks",target:"chapter"})});
