...
#先輩
[yukino/10]「たぶんだけどね、君がついていなかったら、[r]　私はこんなにはしゃげはしなかったと思う」[p]
#春也
「……そうですか？」[p]
...
底なし沼みたいな沈黙が場に満ちる。[p]
[bg2 storage="tekubi2.jpg" time="1000" cross=false wait=true]
#先輩
「……しまったなあ」[p]
...
「ん？」[p]
#
[bg2 storage="tekubi3.jpg" time="1000" cross=false wait=true]
