...
<div id="title_quit" class="title_item" style="left:120px;top:580px;position:absolute;cursor:pointer;">
	<img src="data/image/ru/title_quit.png" alt="" class="non">
</div>
