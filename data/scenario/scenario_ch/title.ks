...
[image storage=alert_zh.png layer=0 top=250 left=300]
[l]
...
<div id="title_quit" class="title_item" style="left:120px;top:580px;position:absolute;cursor:pointer;">
	<img src="data/image/ch/title_quit.png" alt="" class="non">
</div>
...
<img src="data/image/ch/title.png" style="left:860px;top:440px;position:absolute;">
</div>
