...
[macro name="bc/1"][chara_mod name="bucho" storage="bucho/buchoc1.png" cross="false" wait="true" time="%time|100"][endmacro]
[macro name="bc/2"][chara_mod name="bucho" storage="bucho/buchoc2.png" cross="false" wait="true" time="%time|100"][endmacro]
[macro name="bc/3"][chara_mod name="bucho" storage="bucho/buchoc3.png" cross="false" wait="true" time="%time|100"][endmacro]
[macro name="bc/4"][chara_mod name="bucho" storage="bucho/buchoc4.png" cross="false" wait="true" time="%time|100"][endmacro]
[macro name="bc/5"][chara_mod name="bucho" storage="bucho/buchoc5.png" cross="false" wait="true" time="%time|100"][endmacro]
