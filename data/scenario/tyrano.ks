...
[macro name="bucho"][chara_show name="bucho" storage="%storage|bucho.png" page="%page|fore" top="%top|30" left="%left" time="%time|700"][endmacro]
[macro name="bucho1"][chara_show name="bucho" storage="bucho/bucho1.png" page="%page|fore" top="%top|30" left="%left" time="%time|700"][endmacro]
[macro name="bucho2"][chara_show name="bucho" storage="bucho/bucho2.png" page="%page|fore" top="%top|30" left="%left" time="%time|700"][endmacro]
[macro name="bucho3"][chara_show name="bucho" storage="bucho/bucho3.png" page="%page|fore" top="%top|30" left="%left" time="%time|700"][endmacro]
[macro name="bucho4"][chara_show name="bucho" storage="bucho/bucho4.png" page="%page|fore" top="%top|30" left="%left" time="%time|700"][endmacro]
[macro name="bucho5"][chara_show name="bucho" storage="bucho/bucho5.png" page="%page|fore" top="%top|30" left="%left" time="%time|700"][endmacro]
[macro name="bucho6"][chara_show name="bucho" storage="bucho/bucho6.png" page="%page|fore" top="%top|30" left="%left" time="%time|700"][endmacro]
[macro name="bucho7"][chara_show name="bucho" storage="bucho/bucho7.png" page="%page|fore" top="%top|30" left="%left" time="%time|700"][endmacro]
