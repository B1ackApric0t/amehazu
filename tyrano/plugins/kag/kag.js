tyrano.plugin.kag = {
  ...
  backTitleEn: function () {
    "appJsInterface" in window ? appJsInterface.finishGame() : "function" == typeof TyranoPlayer ? webkit.messageHandlers.backHandler.postMessage("endgame") : $.confirm($.lang("go_title_en"), function () {
      location.href = "./index.html"
    }, function () {
      return !1
    })
  },
  backTitleEs: function () {
    "appJsInterface" in window ? appJsInterface.finishGame() : "function" == typeof TyranoPlayer ? webkit.messageHandlers.backHandler.postMessage("endgame") : $.confirm($.lang("go_title_es"), function () {
      location.href = "./index.html"
    }, function () {
      return !1
    })
  },
  backTitleRu: function () {
    "appJsInterface" in window ? appJsInterface.finishGame() : "function" == typeof TyranoPlayer ? webkit.messageHandlers.backHandler.postMessage("endgame") : $.confirm($.lang("go_title_ru"), function () {
      location.href = "./index.html"
    }, function () {
      return !1
    })
  },
  backTitleFr: function () {
    "appJsInterface" in window ? appJsInterface.finishGame() : "function" == typeof TyranoPlayer ? webkit.messageHandlers.backHandler.postMessage("endgame") : $.confirm($.lang("go_title_fr"), function () {
      location.href = "./index.html"
    }, function () {
      return !1
    })
