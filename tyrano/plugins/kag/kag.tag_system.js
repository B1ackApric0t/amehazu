...
},tyrano.plugin.kag.tag.close_ch = {
  pm: {
    ask: "true"
  },
  start: function (t) {
    var a = this;
    "true" == t.ask ? $.confirm($.lang("exit_game_ch"), function () {
      a.close()
    }, function () {
      a.kag.ftag.nextOrder()
    }) : this.close()
...
},tyrano.plugin.kag.tag.close_en = {
  pm: {
    ask: "true"
  },
  start: function (t) {
    var a = this;
    "true" == t.ask ? $.confirm($.lang("exit_game_en"), function () {
      a.close()
    }, function () {
      a.kag.ftag.nextOrder()
    }) : this.close()
...
},tyrano.plugin.kag.tag.close_es = {
  pm: {
    ask: "true"
  },
  start: function (t) {
    var a = this;
    "true" == t.ask ? $.confirm($.lang("exit_game_es"), function () {
      a.close()
    }, function () {
      a.kag.ftag.nextOrder()
    }) : this.close()
...
},tyrano.plugin.kag.tag.close_fr = {
  pm: {
    ask: "true"
  },
  start: function (t) {
    var a = this;
    "true" == t.ask ? $.confirm($.lang("exit_game_fr"), function () {
      a.close()
    }, function () {
      a.kag.ftag.nextOrder()
    }) : this.close()
